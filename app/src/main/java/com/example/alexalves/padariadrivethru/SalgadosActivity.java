...
public class SalgadosActivity extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        departamento[0] = "Coxinha";
        departamento[1] = "Pastel";
        departamento[2] = "Empadinha";
        departamento[3] = "Kibes";
    ...
    private void createListView()
    {
        ...
        ItemListView1 item1 = new ItemListView1("Coxinha", "R$ 2.00", R.drawable.carrinho2);
        ItemListView1 item2 = new ItemListView1("Pastel", "R$ 3.00", R.drawable.carrinho2);
        ItemListView1 item3 = new ItemListView1("Empadinha", "R$ 2.00", R.drawable.carrinho2);
        ItemListView1 item4 = new ItemListView1("Kibe", "R$ 2.00", R.drawable.carrinho2);
